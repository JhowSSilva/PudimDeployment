    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-gray-500">Configurar Instância</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex-1 border-t-2 border-gray-300 mx-4"></div>
            ...
            <div class="bg-white rounded-lg shadow p-8">
                ...
                <p class="text-gray-600 mb-6">Escolha a conta AWS que será usada para provisionar o servidor</p>
                ...
                @if($credentials->isEmpty())
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                        ...
                        <p class="text-gray-800 font-medium mb-2">Nenhuma credencial AWS configurada</p>
                        <p class="text-gray-600 mb-4">Você precisa adicionar uma conta AWS antes de provisionar servidores</p>
                ...
                @else
                    <form action="{{ route('aws-provision.step2') }}" method="POST">
                            ...
                            @foreach($credentials as $credential)
                                <label class="relative">
                                    <input 
                                        ...
                                        required
                                    >
                                    <div class="border-2 border-gray-300 peer-checked:border-blue-600 peer-checked:bg-blue-50 rounded-lg p-4 cursor-pointer hover:border-gray-400 transition">
                                        ...
                                        <p class="text-sm text-gray-600 mb-2">{{ $credential->default_region }}</p>
                                        <div class="flex items-center text-sm text-gray-500">
                                            <code class="text-xs bg-gray-100 px-2 py-1 rounded">{{ $credential->masked_access_key }}</code>
                                        </div>
                                        @if($credential->description)
                                            <p class="text-sm text-gray-600 mt-2">{{ $credential->description }}</p>
                                        @endif
                                    </div>
                                </label>
                            @endforeach
                        ...
                        <div class="flex justify-between items-center pt-6 border-t">
                            <a href="{{ route('servers.index') }}" class="text-gray-600 hover:text-gray-800">
                                ← Cancelar
                            </a>
