<x-layout>
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-turquoise-400 to-turquoise-300 bg-clip-text text-transparent">Credenciais AWS</h1>
        ...
        @if($credentials->isEmpty())
            <div class="bg-neutral-800 backdrop-blur-sm rounded-2xl shadow-xl p-12 text-center border border-neutral-700/50">
                ...
                <p class="text-neutral-400 mb-6 max-w-md mx-auto">Adicione suas credenciais AWS para começar a provisionar servidores EC2 automaticamente</p>
