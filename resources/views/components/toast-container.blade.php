...
<div x-data="toastManager()" 
    ...
    <template x-for="toast in toasts" :key="toast.id">
        <div x-show="toast.visible"
             ...
             class="pointer-events-auto max-w-sm w-full bg-neutral-800 rounded-lg shadow-xl ring-1 ring-neutral-700 border-l-4"
             :class="{
            ...
            <div class="p-4 flex items-start gap-3">
                ...
                <div class="flex-shrink-0">
                    <!-- Success Icon -->
                    <svg x-show="toast.type === 'success'" class="w-6 h-6 text-success-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <!-- Error Icon -->
                    <svg x-show="toast.type === 'error'" class="w-6 h-6 text-error-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <!-- Warning Icon -->
                    <svg x-show="toast.type === 'warning'" class="w-6 h-6 text-warning-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                    </svg>
                    <!-- Info Icon -->
                    <svg x-show="toast.type === 'info'" class="w-6 h-6 text-info-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-neutral-100" x-text="toast.title"></p>
                    <p x-show="toast.message" class="text-sm text-neutral-300 mt-1" x-text="toast.message"></p>
                </div>
                
                <!-- Close Button -->
                <button @click="remove(toast.id)" class="flex-shrink-0 text-neutral-400 hover:text-neutral-200 transition">
            ...
            <!-- Progress Bar -->
            <div x-show="toast.duration > 0" class="h-1 bg-neutral-700 overflow-hidden">
