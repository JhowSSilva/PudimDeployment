<x-layout>
    <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            ...
            <h1 class="mt-2 text-3xl font-bold text-gray-900 dark:text-white">Create New Server</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Configure your server with modern multi-language support</p>
        </div>
        ...
        <div class="mb-8">
            <nav aria-label="Progress">
                <ol role="list" class="space-y-4 md:flex md:space-y-0 md:space-x-8">
                    <li class="md:flex-1">
                        <div class="group pl-4 py-2 flex flex-col border-l-4 border-indigo-600 md:pl-0 md:pt-4 md:pb-0 md:border-l-0 md:border-t-4">
                            <span class="text-xs text-indigo-600 font-semibold tracking-wide uppercase group-hover:text-indigo-800">Step 01</span>
                            <span class="text-sm font-medium">Basic Configuration</span>
                        </div>
                    </li>
                    <li class="md:flex-1">
                        <div class="group pl-4 py-2 flex flex-col border-l-4 border-gray-200 md:pl-0 md:pt-4 md:pb-0 md:border-l-0 md:border-t-4">
                            <span class="text-xs text-gray-500 font-semibold tracking-wide uppercase">Step 02</span>
                            <span class="text-sm font-medium">Programming Language</span>
                        </div>
                    </li>
                    <li class="md:flex-1">
                        <div class="group pl-4 py-2 flex flex-col border-l-4 border-gray-200 md:pl-0 md:pt-4 md:pb-0 md:border-l-0 md:border-t-4">
                            <span class="text-xs text-gray-500 font-semibold tracking-wide uppercase">Step 03</span>
        ...
        <form id="server-form" action="{{ route('servers.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            @csrf
            ...
            <div id="step-1" class="step px-4 py-5 sm:p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="ip_address" id="ip_address" value="{{ old('ip_address') }}" required 
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('ip_address') border-red-300 @enderror">
                    @error('ip_address')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="ssh_port" id="ssh_port" value="{{ old('ssh_port', 22) }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('ssh_port') border-red-300 @enderror">
                        @error('ssh_port')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="os" id="os" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('os') border-red-300 @enderror">
                ...
                <div>
                    <label for="type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Server Type</label>
                    <select name="type" id="type" required
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('type') border-red-300 @enderror">
            ...
            <div id="step-2" class="step hidden px-4 py-5 sm:p-6 space-y-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Programming Language</h3>
                
                <!-- Language Grid -->
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    @foreach($available_languages as $lang => $langData)
                        <div class="language-option border-2 border-gray-200 dark:border-gray-600 rounded-lg p-4 cursor-pointer hover:border-indigo-500 transition-colors"
                             data-language="{{ $lang }}"
                             onclick="selectLanguage('{{ $lang }}')">
                            <div class="flex flex-col items-center text-center">
                                <div class="w-16 h-16 mb-3 flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded-full">
                                    @if($lang === 'php')
                                ...
                                <h4 class="font-medium text-gray-900 dark:text-white">{{ $langData['name'] }}</h4>
                ...
                <div id="version-selection" class="hidden space-y-4">
                    <div class="border-t pt-4">
                        <h4 class="font-medium text-gray-900 dark:text-white mb-4">Select Version</h4>
            ...
            <div id="step-3" class="step hidden px-4 py-5 sm:p-6 space-y-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Stack Configuration</h3>
            ...
            <!-- Navigation Buttons -->
            <div class="px-4 py-3 bg-gray-50 dark:bg-gray-700 text-right sm:px-6 flex justify-between">
                <button type="button" id="prev-btn" 
                    class="hidden inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Previous
                </button>
    ...
    <script>
        let currentStep = 1;
        const availableLanguages = @json($available_languages);
        ...
        function selectLanguage(language) {
            ...
            selectedOption.classList.add('border-indigo-500', 'bg-indigo-50', 'dark:bg-indigo-900/20');
        ...
        function loadStackConfiguration(language) {
            ...
            let html = `
                <!-- Web Server -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Web Server</label>
                    <select name="webserver" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div>
                    ...
                    <select name="database_type" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        <option value="">None</option>
                ...
                <!-- Cache -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Cache Service</label>
                    <select name="cache_service" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        <option value="">None</option>
            ...
            if (language === 'php') {
                html += `
                    <div class="border-t pt-4">
                        <h4 class="font-medium text-gray-900 dark:text-white mb-4">PHP Configuration</h4>
                        <label class="flex items-center">
                            <input type="checkbox" name="install_composer" value="1" checked class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Install Composer</span>
                        </label>
                    </div>
                `;
                ...
                html += `
                    <div class="border-t pt-4">
                        <h4 class="font-medium text-gray-900 dark:text-white mb-4">Node.js Configuration</h4>
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="install_yarn" value="1" checked class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Install Yarn</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="install_pm2" value="1" checked class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Install PM2</span>
                            </label>
                        </div>
                    </div>
                `;
                ...
                html += `
                    <div class="border-t pt-4">
                        <h4 class="font-medium text-gray-900 dark:text-white mb-4">Python Configuration</h4>
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="install_poetry" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Install Poetry</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="install_pipenv" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Install Pipenv</span>
                            </label>
                        </div>
                    </div>
                `;
