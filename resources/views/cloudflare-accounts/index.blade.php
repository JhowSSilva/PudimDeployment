    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            ...
            <div class="mt-4 flex md:mt-0 md:ml-4">
                <a href="{{ route('cloudflare-accounts.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 transition-colors">
                                            ...
                                            <div class="mt-2 flex items-center space-x-4 text-sm text-neutral-300">
                                                @if($account->zone_id)
                                                    <span class="flex items-center">
                                                        <svg class="mr-1.5 h-4 w-4 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
