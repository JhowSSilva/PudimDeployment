        ...
        <div class="bg-neutral-800 border border-neutral-700/50 shadow-lg overflow-hidden sm:rounded-lg">
                    ...
                    @foreach($accounts as $account)
                        <li class="px-6 py-4 hover:bg-neutral-700/50 transition-colors">
                            <div class="flex items-center justify-between">
                                            ...
                                            <div class="mt-2 flex items-center space-x-4 text-sm text-neutral-300">
                                                @if($account->zone_id)
                                                    <span class="flex items-center">
                                                        ...
                                                        Zone ID: {{ Str::limit($account->zone_id, 20) }}
                                                    </span>
                                                @endif
                                                <span class="flex items-center">
                                                    <svg class="mr-1.5 h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('cloudflare-accounts.edit', $account) }}" class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Nenhuma conta cadastrada</h3>
                    <p class="mt-1 text-sm text-gray-500">Comece adicionando uma nova conta Cloudflare.</p>
                    <div class="mt-6">
                        <a href="{{ route('cloudflare-accounts.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                            <svg class="-ml-1 mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                            Nova Conta
