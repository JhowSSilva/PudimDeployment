<x-layout>
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-info-900/20 border border-blue-200 rounded-lg p-4 mb-6">
                <h3 class="font-semibold text-blue-900 mb-2">Como obter suas credenciais AWS:</h3>
                <ol class="list-decimal list-inside space-y-1 text-sm text-info-400">
            ...
            <form action="{{ route('aws-credentials.store') }}" method="POST" class="bg-neutral-800 rounded-lg shadow p-6">
                @csrf
