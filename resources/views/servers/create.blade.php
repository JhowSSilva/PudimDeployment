<x-layout>
    <div class="max-w-3xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            ...
            <h1 class="mt-2 text-3xl font-bold text-neutral-900">Novo Servidor</h1>
            <p class="mt-2 text-sm text-neutral-700">Adicione um novo servidor ao painel</p>
        </div>

        <form action="{{ route('servers.store') }}" method="POST" class="bg-white shadow sm:rounded-lg">
            @csrf
