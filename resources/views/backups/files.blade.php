    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-neutral-900">Arquivos de Backup</h2>
                    <p class="mt-1 text-sm text-neutral-600">{{ $backup->name }}</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-neutral-600">Total de Arquivos</p>
                            <p class="text-2xl font-bold text-neutral-900">{{ $files->total() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-neutral-600">Último Backup</p>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-neutral-600">Tamanho Total</p>
                            <p class="text-lg font-bold text-neutral-900">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-neutral-600">Retention</p>
                            <p class="text-lg font-bold text-neutral-900">{{ $backup->retention_days }} dias</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                @if($files->isEmpty())
                    <div class="p-12 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-neutral-900">Nenhum arquivo de backup</h3>
                                ...
                                <tr class="hover:bg-neutral-50 transition">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-sm font-medium text-neutral-900">{{ $file->filename }}</div>
                                                <div class="text-xs text-neutral-500 font-mono">SHA-256</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-neutral-900">{{ $file->created_at->format('d/m/Y') }}</div>
