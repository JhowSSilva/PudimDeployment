    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow p-8">
                ...
                <p class="text-neutral-600 mb-6">Escolha os componentes que serão instalados no servidor</p>
                ...
                <form action="{{ route('aws-provision.step4') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="relative">
                                    ...
                                    <div class="border-2 border-neutral-300 peer-checked:border-blue-600 peer-checked:bg-blue-50 rounded-lg p-4 cursor-pointer">
                                        ...
                                        <p class="text-sm text-neutral-600">Recomendado para produção</p>
                                    </div>
                                </label>
                                <label class="relative">
                                    ...
                                    <div class="border-2 border-neutral-300 peer-checked:border-blue-600 peer-checked:bg-blue-50 rounded-lg p-4 cursor-pointer">
                                        ...
                                        <p class="text-sm text-neutral-600">Configuração via .htaccess</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- PHP Version -->
                        <div>
                            <label for="php_version" class="block text-sm font-medium text-neutral-700 mb-2">
                                Versão do PHP *
                            </label>
                            <select name="php_version" id="php_version" class="w-full border border-neutral-300 rounded px-3 py-2" required>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <label class="relative">
                                    ...
                                    <div class="border-2 border-neutral-300 peer-checked:border-blue-600 peer-checked:bg-blue-50 rounded-lg p-4 cursor-pointer text-center">
                        ...
                        <!-- Node.js (Optional) -->
                        <div>
                            <label for="nodejs" class="block text-sm font-medium text-neutral-700 mb-2">
                                Node.js (Opcional)
                            </label>
                            <select name="nodejs" id="nodejs" class="w-full border border-neutral-300 rounded px-3 py-2">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="checkbox" name="extras[]" value="supervisor" class="rounded border-neutral-300 text-blue-600" checked>
                                    <span class="ml-2 text-sm">Supervisor (gerenciador de processos)</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="checkbox" name="extras[]" value="docker" class="rounded border-neutral-300 text-blue-600">
