            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                           class="w-full px-4 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                    @error('name')
                ...
                <div class="flex gap-4 pt-4">
                    <button type="submit" class="px-6 py-2 bg-info-600 text-white rounded-lg hover:bg-info-700 transition-colors">
                        Criar Load Balancer
                    </button>
                    <a href="{{ route('scaling.load-balancers.index') }}" class="px-6 py-2 bg-neutral-600 text-white rounded-lg hover:bg-neutral-7000 transition-colors">
                        Cancelar
                    </a>
                </div>
            </div>
