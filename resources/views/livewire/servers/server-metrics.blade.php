<div class="bg-neutral-800 rounded-lg shadow p-6">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold text-neutral-100">Server Metrics</h3>
    ...
    @if($loading)
        <div class="flex items-center justify-center py-8">
            <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-info-600"></div>
        </div>
    ...
    @else
        ...
        <div class="mt-4 pt-4 border-t border-neutral-700">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                    <span class="text-neutral-400">Active Connections:</span>
                    <span class="font-semibold ml-2">{{ $metrics['active_connections'] }}</span>
                </div>
                <div>
                    <span class="text-neutral-400">Uptime:</span>
                    <span class="font-semibold ml-2">{{ $metrics['uptime'] ?? 'N/A' }}</span>
                </div>
                <div>
                    <span class="text-neutral-400">Network In:</span>
                    <span class="font-semibold ml-2">{{ $metrics['network_in'] ?? 'N/A' }}</span>
                </div>
                <div>
                    <span class="text-neutral-400">Network Out:</span>
