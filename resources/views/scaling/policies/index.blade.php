<x-layout title="Políticas de Auto-scaling">
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('scaling.policies.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
            Nova Política
        </a>
    </div>
                ...
                <div class="mb-4 p-4 bg-neutral-700 rounded-lg border border-neutral-600 hover:border-blue-500 transition-colors">
                    <div class="flex justify-between items-start">
                        <div class="flex-1">
                            ...
                            <div class="space-y-1 text-sm text-neutral-400">
                                ...
                                @if($policy->serverPool)
                                    <div>
                                        <span>Pool:</span>
                                        <a href="{{ route('scaling.pools.show', $policy->serverPool) }}" class="text-blue-400 hover:text-blue-300 ml-1">
                        ...
                        <div class="ml-4 flex gap-2">
                            <a href="{{ route('scaling.policies.show', $policy) }}" class="px-3 py-1 bg-neutral-600 text-white rounded text-sm hover:bg-neutral-500">
                                Ver
                            </a>
                            <a href="{{ route('scaling.policies.edit', $policy) }}" class="px-3 py-1 bg-blue-600 text-white rounded text-sm hover:bg-blue-700">
                                Editar
                            </a>
                        </div>
                    </div>
