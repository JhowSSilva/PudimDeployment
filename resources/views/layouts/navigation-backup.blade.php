<nav x-data="{ open: false }" class="bg-white dark:bg-neutral-800 border-b border-neutral-100 dark:border-neutral-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute z-50 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-neutral-800 ring-1 ring-black ring-opacity-5">
                            <div class="py-1">
                                <a href="{{ route('aws-credentials.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">AWS</a>
                                <a href="{{ route('azure-credentials.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">Azure</a>
                                <a href="{{ route('gcp-credentials.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">Google Cloud</a>
                                <a href="{{ route('digitalocean-credentials.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">DigitalOcean</a>
                                <a href="{{ route('cloudflare-accounts.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">Cloudflare</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute z-50 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-neutral-800 ring-1 ring-black ring-opacity-5">
                            <div class="py-1">
                                <div class="px-4 py-2 text-xs font-semibold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider">Banco de Dados</div>
                                <a href="{{ route('databases.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">🗄️ Gerenciar Bancos</a>
                                
                                <div class="border-t border-neutral-100 dark:border-neutral-700 my-1"></div>
                                <div class="px-4 py-2 text-xs font-semibold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider">Workers</div>
                                <a href="{{ route('queue-workers.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">⚡ Queue Workers</a>
                                
                                <div class="border-t border-neutral-100 dark:border-neutral-700 my-1"></div>
                                <div class="px-4 py-2 text-xs font-semibold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider">SSL</div>
                                <a href="{{ route('ssl-certificates.index') }}" class="block px-4 py-2 text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700">🔒 Certificados SSL</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Cloud Credentials -->
            <div class="pt-2 pb-2 border-t border-neutral-200 dark:border-neutral-600">
                <div class="px-4 text-xs font-semibold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider">Clouds</div>
            ...
            <!-- Tools -->
            <div class="pt-2 pb-2 border-t border-neutral-200 dark:border-neutral-600">
                <div class="px-4 text-xs font-semibold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider">Ferramentas</div>
