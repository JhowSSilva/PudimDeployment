    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6" x-data="{ activeTab: 'profile' }">
                <div class="flex space-x-2 border-b border-neutral-700">
                ...
                <div x-show="activeTab === 'profile'" x-cloak class="mt-6">
                    <div class="bg-neutral-800 rounded-2xl shadow-lg border border-neutral-700 p-8">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $user->name) }}" required class="w-full px-4 py-3 rounded-lg border border-neutral-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $user->email) }}" required class="w-full px-4 py-3 rounded-lg border border-neutral-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                                    @error('email')
                                        <p class="text-error-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <form action="{{ route('profile.password') }}" method="POST">
                        ...
                        <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="password" name="current_password" required class="w-full px-4 py-3 rounded-lg border border-neutral-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password" required class="w-full px-4 py-3 rounded-lg border border-neutral-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                                    @error('password')
                                        <p class="text-error-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password_confirmation" required class="w-full px-4 py-3 rounded-lg border border-neutral-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <form action="{{ route('profile.teams.create') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="name" required class="w-full px-4 py-3 rounded-lg border border-neutral-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                                    </div>

                                    <div>
                                        <label class="block text-sm font-medium text-neutral-200 mb-2">Descrição (opcional)</label>
                                        <textarea name="description" rows="3" class="w-full px-4 py-3 rounded-lg border border-neutral-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent"></textarea>
                                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            @forelse($ownedTeams as $team)
                                <div class="bg-neutral-800 rounded-xl shadow-lg border border-neutral-700 p-6 hover:shadow-2xl hover:scale-[1.02] transition-all">
                            ...
                            @empty
                                <div class="bg-neutral-900 border-2 border-dashed border-neutral-700 rounded-xl p-8 text-center">
