...
<head>
    ...
    <title>{{ $title ?? "Agile'sDeployment - Cloud Management Platform" }}</title>
        ...
        <div class="flex-1 lg:ml-72 min-h-screen">
            <main class="py-8">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <!-- Flash Messages -->
                    @if(session('success'))
                        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" class="mb-6 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 p-4 shadow-sm">
                            <div class="flex">
                                ...
                                <div class="ml-auto pl-3">
                                    <button @click="show = false" class="inline-flex rounded-lg p-1.5 text-green-600 hover:bg-green-100 transition-colors">
