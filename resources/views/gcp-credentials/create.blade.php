    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-neutral-900">Nova Credencial Google Cloud</h1>
                <p class="text-neutral-600 mt-1">Adicione uma nova credencial Google Cloud Platform</p>
            </div>
