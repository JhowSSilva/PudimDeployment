                    ...
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <div class="flex items-center gap-3">
                                <div class="w-16 h-16 bg-gradient-to-br from-primary-600 to-primary-700 rounded-2xl flex items-center justify-center shadow-2xl shadow-primary-600/40">
                                    <x-application-logo class="w-9 h-9 text-white" />
                                </div>
                                <h1 class="text-3xl lg:text-4xl font-bold text-primary-700">
                                    Pudim Deployment
                                </h1>
                            </div>
                        </div>
                                </div>
                                <h1 class=\"text-3xl lg:text-4xl font-bold bg-gradient-to-r from-purple-400 via-primary-400 to-purple-500 bg-clip-text text-transparent\">
                                    Pudim Deployment
                                </h1>
                            </div>
                        </div>
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Pudim Deployment</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Uma plataforma completa de gerenciamento de servidores e deployment automatizado. Gerencie seus servidores, sites, bancos de dados, SSL, filas e muito mais em uma interface moderna e intuitiva.
                                    </p>
                                </div>
                            </div>
                        </div>
