    ...
    <div class="max-w-3xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Nova Conta Cloudflare</h1>
            </div>
            <p class="text-sm text-gray-700">Adicione uma nova conta Cloudflare para gerenciar DNS e SSL</p>
        </div>
        ...
        <div class="bg-white shadow sm:rounded-lg">
            <form action="{{ route('cloudflare-accounts.store') }}" method="POST" class="space-y-6 p-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Um nome descritivo para identificar esta conta (ex: "Conta Principal", "Cliente XYZ")</p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Token de API da Cloudflare com permissões para DNS e SSL</p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">ID da conta Cloudflare (opcional, encontrado no Dashboard)</p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">ID da zona padrão (opcional, pode ser detectado automaticamente pelo domínio)</p>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('description') border-red-300 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        ...
                        <p class="text-gray-500">Desmarque para desativar temporariamente esta conta sem removê-la</p>
                    </div>
                </div>
