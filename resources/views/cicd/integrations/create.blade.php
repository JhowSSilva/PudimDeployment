    ...
    <div class="bg-neutral-800 overflow-hidden shadow-xl sm:rounded-lg">
        <form action="{{ route('cicd.integrations.store') }}" method="POST" class="p-6" x-data="{ provider: 'slack' }">
            ...
            <div class="mb-4">
                ...
                <select name="provider" x-model="provider" required class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 text-white rounded-md focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50">
            ...
            <div class="mb-4 p-4 bg-neutral-700 rounded">
                ...
                <div class="space-y-2">
                    <label class="flex items-center">
                        <input type="checkbox" name="events[]" value="deployment_started" class="mr-2 bg-neutral-600 border-neutral-500 text-info-400 focus:ring-primary-500">
                        <span class="text-neutral-300 text-sm">Deployment Iniciado</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="events[]" value="deployment_succeeded" checked class="mr-2 bg-neutral-600 border-neutral-500 text-info-400 focus:ring-primary-500">
                        <span class="text-neutral-300 text-sm">Deployment Sucesso</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="events[]" value="deployment_failed" checked class="mr-2 bg-neutral-600 border-neutral-500 text-info-400 focus:ring-primary-500">
                        <span class="text-neutral-300 text-sm">Deployment Falhou</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="events[]" value="approval_required" class="mr-2 bg-neutral-600 border-neutral-500 text-info-400 focus:ring-primary-500">
                        <span class="text-neutral-300 text-sm">Aprovação Necessária</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="events[]" value="approval_granted" class="mr-2 bg-neutral-600 border-neutral-500 text-info-400 focus:ring-primary-500">
                        <span class="text-neutral-300 text-sm">Aprovação Concedida</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="events[]" value="rollback_initiated" class="mr-2 bg-neutral-600 border-neutral-500 text-info-400 focus:ring-primary-500">
