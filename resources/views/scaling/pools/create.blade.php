        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('scaling.pools.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="min_servers" id="min_servers" value="{{ old('min_servers', 1) }}" min="1" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    @error('min_servers')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" name="max_servers" id="max_servers" value="{{ old('max_servers', 10) }}" min="1" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    @error('max_servers')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" name="desired_servers" id="desired_servers" value="{{ old('desired_servers', 2) }}" min="1" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="health_check_interval" id="health_check_interval" value="{{ old('health_check_interval', 30) }}" min="10" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                ...
                                <div class="flex items-center h-full pt-6">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="auto_healing" value="1" {{ old('auto_healing') ? 'checked' : '' }}
                        ...
                        <!-- Server Selection -->
                        <div class="pb-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Initial Servers</h3>
                            ...
                            @else
                                <div class="text-center py-8 bg-gray-50 rounded-lg">
                                    ...
                                    <p class="text-xs text-gray-500">Create servers first to add them to a pool</p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                            <a href="{{ route('scaling.pools.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                                Cancel
                            </a>
