    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-3xl font-bold text-neutral-900">Criar Backup</h2>
                    ...
                    <div class="p-6">
                        ...
                        <div x-show="currentTab === 'database'" x-transition>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-neutral-700 mb-2">Servidor</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-neutral-700 mb-2">Database</label>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="encryption_enabled" value="1" class="rounded border-neutral-300 text-amber-600 focus:ring-amber-600">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="border border-neutral-200 rounded-lg p-4">
                                    <label class="flex items-center mb-3">
                                        <input type="checkbox" name="notifications[email][enabled]" value="1" class="rounded border-neutral-300 text-amber-600 focus:ring-amber-600">
                                    ...
                                    <div class="ml-6 space-y-3">
                                        ...
                                        <div class="flex gap-4">
                                            <label class="flex items-center">
                                                <input type="checkbox" name="notifications[email][on_success]" value="1" class="rounded border-neutral-300 text-amber-600 focus:ring-amber-600">
                                                <span class="ml-2 text-sm text-neutral-700">Sucesso</span>
                                            </label>
                                            <label class="flex items-center">
                                                <input type="checkbox" name="notifications[email][on_failure]" value="1" checked class="rounded border-neutral-300 text-amber-600 focus:ring-amber-600">
                                ...
                                <div class="border border-neutral-200 rounded-lg p-4">
                                    <label class="flex items-center mb-3">
                                        <input type="checkbox" name="notifications[webhook][enabled]" value="1" class="rounded border-neutral-300 text-amber-600 focus:ring-amber-600">
                                ...
                                <div class="border border-neutral-200 rounded-lg p-4">
                                    <label class="flex items-center mb-3">
                                        <input type="checkbox" name="notifications[slack][enabled]" value="1" class="rounded border-neutral-300 text-amber-600 focus:ring-amber-600">
                                ...
                                <div class="border border-neutral-200 rounded-lg p-4">
                                    <label class="flex items-center mb-3">
                                        <input type="checkbox" name="notifications[discord][enabled]" value="1" class="rounded border-neutral-300 text-amber-600 focus:ring-amber-600">
                    ...
                    <div class="border-t border-neutral-200 px-6 py-4 flex justify-between">
                        ...
                        <div class="flex gap-3 ml-auto">
                            ...
                            <button type="submit" x-show="currentTab === 'notifications'" @click="showLoading()"
                                    class="px-6 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition shadow-lg shadow-amber-600/20 hover-scale">
                                Criar Backup
                            </button>
                        </div>
                    </div>
