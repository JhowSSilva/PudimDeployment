...
<nav class="bg-neutral-800 border-b border-neutral-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button class="inline-flex items-center justify-center p-2 rounded-md text-neutral-400 hover:text-neutral-500 hover:bg-neutral-700 focus:outline-none focus:bg-neutral-700 focus:text-neutral-500 transition duration-150 ease-in-out">
