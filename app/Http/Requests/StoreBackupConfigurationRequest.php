...
class StoreBackupConfigurationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'database_id' => ['required', 'exists:backup_databases,id'],
            'storage_provider' => ['required', 'in:aws_s3,azure_blob,google_cloud,do_spaces,backblaze_b2,wasabi,minio,local'],
            'storage_path' => ['required', 'string', 'max:500'],
            'storage_credentials' => ['required', 'array'],
            'frequency' => ['required', 'in:hourly,every_6_hours,every_12_hours,daily,weekly,monthly'],
            'start_time' => ['nullable', 'date_format:H:i'],
            'timezone' => ['required', 'string', 'timezone'],
            'day_of_week' => ['nullable', 'integer', 'between:0,6'],
            'day_of_month' => ['nullable', 'integer', 'between:1,31'],
            'keep_backups' => ['required', 'integer', 'min:0'],
            'compression' => ['required', 'in:zip,tar,tar_gz,tar_bz2,none'],
