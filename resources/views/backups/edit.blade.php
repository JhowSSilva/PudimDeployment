    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-3xl font-bold text-neutral-100">Editar Backup</h2>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="encryption_enabled" value="1" {{ $backup->encryption_enabled ? 'checked' : '' }} 
                                               class="rounded border-neutral-600 text-primary-600 focus:ring-primary-600">
                                ...
                                <div>
                                    ...
                                    <textarea name="exclusions" rows="3"
                                              class="w-full px-4 py-2 border border-neutral-600 rounded-lg focus:ring-2 focus:ring-primary-600 focus:border-transparent">{{ is_array($backup->exclusions) ? implode(',', $backup->exclusions) : $backup->exclusions }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-t border-neutral-700 px-6 py-4 flex justify-between">
                        ...
                        <div class="flex gap-3 ml-auto">
                            ...
                            <button type="submit" x-show="currentTab === 'notifications'"
                                    class="px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition shadow-lg shadow-primary-600/20">
                                Salvar Alterações
                            </button>
                        </div>
                    </div>
